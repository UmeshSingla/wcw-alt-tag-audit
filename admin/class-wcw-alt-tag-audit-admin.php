...
class Wcw_Alt_Tag_Audit_Admin {
	...
	public static function admin_notice() {
		...
		if ( $visited_cookie == null || $alt_text_needs_review == 'needs_review' ) {
            ...
            <div class="notice notice-warning is-dismissible">
                <p>You may have images that require their alt text reviewed. <a
                            href="<?php echo admin_url( $link_to ); ?>">Double check your alt text as soon as
                        possible.</a></p>
            </div>
		...
		if ( $alt_text_needs_review == 'true' ) :
            ...
            <div class="notice notice-error is-dismissible">
                <p>You have images that require their alt text reviewed. <a href="<?php echo admin_url( $link_to ); ?>">Please
                        address these issues as soon as possible.</a></p>
            </div>
	...
	public function setup_options_page() {
		add_submenu_page( 'tools.php', 'Alt Tags Audit', 'Alt Tags Audit', 'edit_posts', 'edit_alt_tags', array(
			__CLASS__,
			'render_options_page'
		) );
	}
